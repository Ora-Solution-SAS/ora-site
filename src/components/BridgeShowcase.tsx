...
export function BridgeAnimation({ theme }: BridgeShowcaseProps) {
  ...
  return (
    <section ref={outerRef} className="relative bg-white dark:bg-black md:dark:bg-black">
...
export default function BridgeShowcase({ theme }: BridgeShowcaseProps) {
  ...
  return (
    <section data-nav-shy className="relative pt-24 md:pt-36 pb-24 md:pb-32 px-6 md:px-12 bg-white dark:bg-black md:dark:bg-black">
