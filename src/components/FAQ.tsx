...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="relative py-12 md:py-32 px-5 md:px-12 bg-white dark:bg-black md:dark:bg-black scroll-mt-24">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-6 md:mb-16">
          <span className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-500 dark:text-blue-400">
            {t({ fr: "FAQ", en: "FAQ" })}
          </span>
          <h2 className="font-poppins font-semibold text-[1.5rem] md:text-[2.75rem] tracking-[-0.03em] leading-[1.12] text-[#111827] dark:text-white mt-2 md:mt-4">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 text-left px-3.5 py-2.5 md:gap-4 md:px-6 md:py-5"
                  aria-expanded={isOpen}
                  aria-controls={`faq-panel-${i}`}
                  id={`faq-button-${i}`}
                >
                  <span className="font-poppins font-semibold text-[12.5px] max-md:leading-snug md:text-[16px] text-gray-900 dark:text-white">
                    {item.q}
                  </span>
                  <ChevronDown
                ...
                >
                  <div className="overflow-hidden">
                    <p className="font-inter px-3.5 pb-3 text-[11.5px] max-md:leading-snug leading-relaxed md:px-6 md:pb-5 md:text-[14.5px] text-gray-500 dark:text-gray-400">
                      {item.a}
                    </p>
                  </div>
                </div>
