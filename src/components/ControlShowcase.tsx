  ...
  return (
    <section
      ...
      /* Pied ramené de pb-40 à pb-16 (client 2026-09-02 : « réduis l'espace
         ...
         Gouttière et retrait haut du TÉLÉPHONE : palier de cette branche
         (px-5, pt-16). main n'y a pas touché — il n'a bougé que le pied. */
      className="relative px-5 md:px-12 pt-16 md:pt-32 pb-12 md:pb-16 bg-[#fcfbf7] dark:bg-black"
