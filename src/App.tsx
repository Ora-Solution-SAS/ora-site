...
const App = () => {
  ...
  return (
    ...
    >
      ...
      <section id="features" className="relative pt-10 md:pt-28 pb-0 px-5 md:px-12 bg-[#fcfbf7] dark:bg-black md:dark:bg-background">
      ...
      <section className="relative px-5 md:px-12 pt-10 md:pt-8 pb-20 md:pb-56 bg-white dark:bg-black md:dark:bg-black">
        <div className="mx-auto max-w-[46rem] text-center">
          <h2 className="font-instrument font-normal text-[clamp(1.45rem,4vw,3rem)] leading-[1.12] tracking-[-0.03em]">
