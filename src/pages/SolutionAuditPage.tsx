            ...
            {solutions.map((sol, i) => {
              ...
              return (
                <div
                  key={i}
                  className={[
                    "au-card p-4 rounded-[14px] md:p-7 md:rounded-[20px] border transition-colors duration-200",
                    borderMuted, cardBg,
                ...
                >
                  <div
                    className={[
                      "w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-5",
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5">
            {conformitePoints.map((pt, i) => (
              <div
                key={i}
                className={[
                  "au-card flex gap-3 md:gap-5 p-4 rounded-[14px] md:p-7 md:rounded-[20px] border",
                  borderMuted,
              ...
              >
                ...
                <div
                  className={[
                    "flex-shrink-0 w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl flex items-center justify-center md:mt-0.5",
                ...
                <div>
                  <h3
                    className={[
                      "font-poppins text-[12.5px] md:text-[15px] font-semibold tracking-tight leading-snug mb-1 md:mb-1.5",
                      textPrimary,
                    ].join(" ")}
                  >
                    {pt.title}
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:gap-6">
            {testimonials.map((testi, i) => (
              <div
                key={i}
                className={[
                  "au-testi flex flex-col gap-3 md:gap-5 p-4 rounded-[14px] md:p-7 md:rounded-[20px] border",
                  borderMuted, cardBg,
                ].join(" ")}
