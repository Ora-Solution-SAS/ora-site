    ...
    <div className={ready ? "fi-ready" : ""}>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:gap-20 items-center">
            <div className="max-w-[540px]">
              ...
              <p
                className={[
                  "fi-stagger fi-d3",
                  "font-inter mt-4 md:mt-6 text-[clamp(0.85rem,1.6vw,1.05rem)] max-md:leading-[1.6] leading-[1.8]",
                  textSecondary,
                ].join(" ")}
              >
                {t({
      ...
      {/* ══ 2. SOLUTIONS ══ */}
      <section className="py-12 md:py-32 px-5 lg:px-10" style={{ background: bgContrast }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-7 md:mb-16 max-w-2xl mx-auto">
            <h2 className={["font-poppins text-[clamp(1.4rem,3.5vw,2.75rem)] font-semibold leading-[1.15] tracking-[-0.03em]", textPrimary].join(" ")}>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-3">
            {solutions.map((sol, i) => {
              ...
              return (
                <div
                  key={i}
                  className={["fi-card p-4 rounded-[14px] md:p-7 md:rounded-[20px] border transition-colors duration-200", borderMuted, cardBg, dk ? "hover:bg-white/[0.05]" : "hover:bg-gray-50/70"].join(" ")}
                  data-delay={String(i * 80)}
                >
                  <div className={["w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-5", dk ? "bg-blue-500/10" : "bg-blue-50"].join(" ")}>
                  ...
                  <p className={["font-inter text-[11px] md:text-[14px] max-md:leading-snug leading-relaxed", textSecondary].join(" ")}>
                    {sol.desc}
                  </p>
                </div>
              );
          ...
          <div className={["mt-12 flex flex-col sm:flex-row sm:items-center gap-5 px-7 py-5 rounded-2xl border", borderMuted, dk ? "bg-white/[0.025]" : "bg-blue-50/40"].join(" ")}>
            <p className={["font-inter text-[11.5px] md:text-[15px] max-md:leading-snug leading-relaxed flex-1", textSecondary].join(" ")}>
      ...
      <section className="py-12 md:py-32 px-5 lg:px-10" style={{ background: bg }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:gap-20 items-start mb-8 md:mb-16">
            <div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5">
            {performancePoints.map((pt, i) => (
              <div
                key={i}
                className={["fi-card flex gap-3 md:gap-5 p-4 rounded-[14px] md:p-7 md:rounded-[20px] border", borderMuted, dk ? "bg-white/[0.025]" : "bg-white"].join(" ")}
                data-delay={String(i * 90)}
              >
                <div className={["flex-shrink-0 w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl flex items-center justify-center md:mt-0.5", dk ? "bg-teal-500/10" : "bg-teal-50"].join(" ")}>
                  <CheckCircle className="w-5 h-5 text-teal-500" />
                </div>
                <div>
                  <h3 className={["font-poppins text-[12.5px] md:text-[15px] font-semibold tracking-tight leading-snug mb-1 md:mb-1.5", textPrimary].join(" ")}>
                    {pt.title}
                  </h3>
                  <p className={["font-inter text-[11px] md:text-[14px] max-md:leading-snug leading-relaxed", textSecondary].join(" ")}>
                    {pt.desc}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:gap-6">
            {testimonials.map((testi, i) => (
              <div
                key={i}
                className={["fi-testi flex flex-col gap-3 md:gap-5 p-4 rounded-[14px] md:p-7 md:rounded-[20px] border", borderMuted, cardBg].join(" ")}
              ...
              >
                ...
                <blockquote className={["font-inter text-[11.5px] md:text-[15px] max-md:leading-snug leading-relaxed flex-1", textSecondary].join(" ")}>
      ...
      {/* ══ 5. CTA ══ */}
      <section className="py-12 md:py-28 px-5 lg:px-10" style={{ background: bg }}>
        <div className="max-w-3xl mx-auto text-center">
          <div className={["rounded-[20px] px-5 py-8 border md:rounded-[32px] md:px-10 md:py-16", borderMuted, dk ? "bg-white/[0.03]" : "bg-gray-50/80"].join(" ")}>
            <TrendingUp className="w-10 h-10 text-blue-500 mx-auto mb-6" />
            <h2 className={["font-poppins text-[clamp(1.3rem,3vw,2.5rem)] font-semibold tracking-[-0.03em]", textPrimary].join(" ")}>
