          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
            {solutions.map((sol, i) => {
              ...
              return (
                <div
                  key={i}
                  className={["ba-card p-6 rounded-[18px] md:p-7 md:rounded-[20px] border transition-colors duration-200", borderMuted, cardBg, dk ? "hover:bg-white/[0.05]" : "hover:bg-gray-50/70"].join(" ")}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
            {executionPoints.map((pt, i) => (
              <div
                key={i}
                className={["ba-card flex gap-3 md:gap-5 p-6 rounded-[18px] md:p-7 md:rounded-[20px] border", borderMuted, dk ? "bg-white/[0.025]" : "bg-white"].join(" ")}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-4 md:grid-cols-3 md:gap-6">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className={["ba-testi flex flex-col gap-3 md:gap-5 p-6 rounded-[18px] md:p-7 md:rounded-[20px] border", borderMuted, cardBg].join(" ")}
