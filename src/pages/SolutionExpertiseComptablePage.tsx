            ...
            {solutions.map((sol, i) => {
              ...
              return (
                <div
                  key={i}
                  className={[
                    "ec-card p-4 rounded-[14px] md:p-7 md:rounded-[20px] border transition-colors duration-200",
                    borderMuted, cardBg,
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:gap-6">
            {testimonials.map((testi, i) => (
              <div
                key={i}
                className={[
                  "ec-testi flex flex-col gap-3 md:gap-5 p-4 rounded-[14px] md:p-7 md:rounded-[20px] border",
                  borderMuted, cardBg,
                ].join(" ")}
